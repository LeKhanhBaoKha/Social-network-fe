            ...
            <NavLink className="hover:cursor-pointer">
              <div className="w-[400px] flex flex-row justify-between border p-4 rounded-xl">
                ...
                <div className="flex items-center">
                  ...
                  {/* <button className="h-[40px] p-2 rounded-lg text-lg text-white bg-purple-500 mr-[10px] hover:bg-purple-600 transition-colors">
