...
export default function ProfileHeader() {
  ...
  return (
    <div className="w-screen ">
      <div className="w-[940px] bg-white m-auto rounded-xl">
        {/* background-img */}
        <div className="w-[940px] h-[400px] overflow-hidden rounded-xl m-auto">
        ...
        <div className="flex justify-center">
          <div className="user flex mx-8 justify-between w-[876px] h-[130px]">
            <div className="flex">
              {/* avatar */}
        ...
        <div className="border-t border-gray-300 w-[876px] m-auto flex gap-[3px] ">
          {tabs.map(({ name, url }) => (
            <NavLink
              to={url}
              onClick={() => {
