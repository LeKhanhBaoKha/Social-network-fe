...
const SideBar = () => {
  ...
  return (
    <div className="w-[259px] h-[370px] bg-white border">
      <div className="mt-[18px]">
        {tabs.map(({ name, svg, url }) => (
          ...
          >
            <div
              className={`mt-[10px] py-[2px] w-[200px] h-[40px] ml-[19px] flex rounded-xl 
                    ${
                      activeTab.includes(url)
                        ? "bg-[#1B66C9] text-white"
                        : "hover:bg-[#E6E6E6] transition-all"
                    }`}
            >
              {svg}
